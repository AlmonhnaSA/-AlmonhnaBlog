...
/**
 * روابط المنصات (معدلّة لتستخدم /api/share)
 */
const SHARE_PLATFORMS = [
  {
    ...
    getUrl: (shareUrl: string, title: string) =>
...
export const ShareDialog = ({
  ...
  // رابط الشير الحقيقي (هذا أهم سطر)
  const shareUrl =
    "https://www.almonhna.sa/api/share?id=" + extractId(url);

  const shownUrl = displayUrl || shareUrl;
